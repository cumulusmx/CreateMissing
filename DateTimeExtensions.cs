...
namespace CumulusMX
{
	public static class DateTimeExtensions
	{
		...
		public static long ToUnixTime(this DateTime dateTime)
		{
			...
			{
				Console.WriteLine("ToUnixTime: Exception - " + ex.Message);
				return 0;
			}
		}
		...
		public static long ToUnixTimeMs(this DateTime dateTime)
		{
			...
			{
				Console.WriteLine("ToUnixTimeMs: Exception - " + ex.Message);
				return 0;
			}
		}
		...
		public static DateTime FromUnixTime(this long unixTime)
		{
			...
			{
				Console.WriteLine("FromUnixTime: Exception - " + ex.Message);
		...
		public static DateTime RoundTimeUpToInterval(this DateTime dateTime, TimeSpan intvl)
		{
			...
			{
				Console.WriteLine("RoundTimeUpToInterval: Exception - " + ex.Message);
				return dateTime;
			}
		}
		...
		public static DateTime RoundTimeDownToInterval(this DateTime dateTime, TimeSpan intvl)
		{
			...
			{
				Console.WriteLine("RoundTimeDownToInterval: Exception - " + ex.Message);
				return dateTime;
			}
		...
		public static DateTime RoundTimeToInterval(this DateTime dateTime, int intvl)
		{
			...
			{
				Console.WriteLine("RoundTimeToInterval: Exception - " + ex.Message);
				return dateTime;
			}
		}
	}
